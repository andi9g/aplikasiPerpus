...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-secondary elevation-4 bg-dark">
        <!-- Brand Logo -->
          ...
          <nav class="mt-2 mr-2 pr-1">
            <ul class="nav nav-flat nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              @if (Session::get('status')=='admin')
                  ...
                  <li class="nav-item hoverku @yield('activeDataLaporan')">
...
<footer class="main-footer ">
  <strong>Copyright &copy; 2021 <a href="#">Aplikasi Perpustakaan
</footer>
